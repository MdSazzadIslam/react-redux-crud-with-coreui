...
const CreateCategory = React.lazy(() =>
  import("./views/settings/category/CreateCategory")
);

const CategoryList = React.lazy(() =>
  import("./views/settings/category/CategoryList")
);

const EditCategory = React.lazy(() =>
  import("./views/settings/category/EditCategory")
);
...
const routes = [
  ...
  {
    path: "/category/edit/:id/:name/:status",
    name: "EditCategory",
    component: EditCategory,
  },
];
